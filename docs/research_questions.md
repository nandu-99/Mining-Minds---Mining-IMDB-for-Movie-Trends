...
1. **Impact of Star Power on Rating Stability:**
...
2. **The Effect of Runtime on Ratings Within Genres:**
...
6. **Identifying Key Drivers of Rating and Popularity:**
...
7. **Model Comparison for Rating Prediction (Metadata-Only):**
    Which machine learning model (e.g., Ridge Regression, Random Forest) achieves the best predictive performance for IMDb rating using only structured metadata, and how can interpretability techniques (e.g., SHAP) be used to explain the relative influence of factors like genre vs. runtime?
...
8. **Tracking Genre Trends in Popularity and Quality:**
