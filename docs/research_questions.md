...
4. **Model "Breakout" Potential:** Identify the metadata signatures that allow non-mainstream (regional/foreign) films to achieve mainstream global popularity.
5. **Develop a Risk Assessment Model:** Move beyond simple success prediction to instead identify films at high risk of being a "High Profile Flop" (high value inputs but a low audience rating).
